  ...
  return (
    <div className="drawer">
          ...
          <div className="navbar-start">
            ...
            <div className="dropdown lg:hidden">
              <label
                ...
                className="btn btn-ghost btn-circle text-base-content dark:text-gray-100"
              >
            ...
            <Link
              to="/"
              className="btn btn-ghost text-xl font-bold gradient-text hidden lg:inline-flex"
            >
              Skillex
            </Link>
          </div>
      ...
      <div className="drawer-side lg:hidden">
        ...
        <aside className="w-80 min-h-screen bg-white dark:bg-gray-800 pt-16 shadow-lg">
          ...
          <ul className="menu p-4 w-full text-base-content dark:text-gray-100">
            <li>
            ...
            <li>
              <Link to="/courses" onClick={() => setIsDrawerOpen(false)}>
                Courses
              </Link>
            </li>
            <li>
